...
export class ComprobantesPagosController {
  ...
  @ApiResponse({ status: 404, description: 'Comprobante de pago no encontrado' })
  @Get(':id')
  ...
  @ApiParam({ name: 'id', description: 'ID del comprobante de pago a actualizar' })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiParam({ name: 'id', description: 'ID del comprobante de pago a eliminar' })
  @ApiResponse({ 
    status: 200, 
